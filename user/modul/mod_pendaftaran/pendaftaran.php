	...
	<section class="content-header">
		<div class="row">
			<div class="col-xs-6">
		      ...
		      <br />
			YANG TELAH MENGIKUTI TEST</div>
            <div class="col-xs-2 pull-right"><a href="<?php echo $aksi; ?>?module=pendaftaran&act=export-pdf" target="_blank" class="btn btn-block btn-primary"><i class="fa fa-file-pdf-o"></i> &nbsp; PDF</a></div>
			<div class="col-xs-2 pull-right"><a href="<?php echo $aksi; ?>?module=pendaftaran&act=export-excel" class="btn btn-block btn-primary"><i class="fa fa-file-excel-o"></i> &nbsp; EXCEL</a></div>
		</div>
	</section>
					...
					<table id="pendaftarandata" class="table table-bordered table-striped">
						<thead>
							<tr>
								...
								<th width="24">NO</th>
								<th width="92">NO PENDAFTARAN</th>
								<th width="66">NAMA</th>
								<th width="30">TTL</th>
								
								<th width="119">TANGGAL DAFTAR</th>
								<th width="57">NILAI AF</th>
								<th width="57">NILAI PSi</th>
						...
						<tbody>
							<?php
							$mySql 	= "SELECT * FROM siswa,nilai_siswa , agama WHERE siswa.id_agama=agama.id_agama AND siswa.nopes=nilai_siswa.nopes AND siswa.status='SIAP' OR siswa.id_agama=agama.id_agama AND siswa.nopes=nilai_siswa.nopes  AND siswa.status='BELUM SIAP' ORDER BY siswa.nopes ASC ";
							...
							?>
								<tr>
									...
									<td><?php echo $myData['nilai_afektif']; ?></td>
									<td><?php echo $myData['nilai_psikomotorik']; ?></td>
									...
									<td class="text-center">
                                       ...
                                       <a href="modul/mod_pendaftaran/delete.php?nopes=<?php echo $myData['nopes']; ?>"  onclick="javascript:return confirm('Hapus Nilai?');" class="btn btn-danger btn-xs" alt="Hapus Nilai" title="Hapus Nilai"><i class="fa fa-close"></i></a> 
                                       <?php 
									   $nopes= $myData['nopes'];
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				...
				<dl class="dl-horizontal">
                    ...
                    <dt>Nilai Afektif</dt> <dd><?php echo $myData['nilai_afektif']; ?></dd>
                    <dt>Nilai Psikomotorik</dt> <dd><?php echo $myData['nilai_psikomotorik']; ?></dd>
                    <dt>Status</dt> <dd><?php echo $myData['status']; ?></dd>
