...
?>
	<section class="content-header">
		<div class="row">
			<div class="col-xs-6">
		      ...
		      <br />
			YANG BELUM MELAKUKAN KONFIRMASI PENDAFTARAN</div>
			<div class="col-xs-2 pull-right"><a href="<?php echo $aksi; ?>?module=belumkonfirmasi&act=export-excel" class="btn btn-block btn-primary"><i class="fa fa-file-excel-o"></i> &nbsp; EXPORT</a></div>
		</div>
	</section>
	...
	<section class="content">
		...
		<div class="col-xs-12">
			...
			<div class="box">
				<div class="box-body">
				  <form method="post" action="<?php echo $aksi; ?>?module=belumkonfirmasi&act=ubahstatus">
					<table id="pendaftarandata" class="table table-bordered table-striped">
						<thead>
							<tr>
								<th width="20"><input type="checkbox" class="minimal" id="checkAll"></th>
								<th width="24">NO</th>
						...
						<tbody>
							<?php
							$mySql 	= "SELECT * FROM siswa, agama WHERE siswa.id_agama=agama.id_agama AND status='DAFTAR' ORDER BY nopes DESC";
							...
							?>
								<tr>
									<td class="text-center"><input type="checkbox" class="minimal" id="cek[]" name="cek[]" value="<?php echo $myData['nopes']; ?>" /></td>
		...
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<div class="box-footer">
					...
					<div class="col-sm-1">
						<input name="applystatuspendaftaran" id="applystatuspendaftaran" onclick="javascript:return confirm();" type="submit" class="btn btn-primary" value="APPLY" />
					</div> <!-- /.col-sm-1 -->
				</div> <!-- /.box-footer -->
			  </form>
			</div> <!-- .box -->
