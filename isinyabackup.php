...
$nopes= $_POST['nopes'];
$ada = mysqli_query($colok,"SELECT * from siswa where nopes='$nopes'");
$adaengga = mysqli_num_rows($ada);
if($adaengga == 0) echo "<br><div class='alert alert-dismissable alert-danger'><h4>Maaf, Nomor Peserta Salah Atau Tidak Ada Dalam Database!</h4></div><meta http-equiv='refresh' content='10; url=pengumuman.html'>";
else 
...
echo "</table>";
echo "<div align='center'><a href='printsk.php?id_siswa=".$datanya['id_siswa']."' class='btn btn-success'>Cetak Surat Pengumuman PPDB</a></div>";
}	
		...
		<div class="nav-tabs-custom">
			<div class="tab-content">
				<div class="tab-pane active" id="tab_1">
					...
					<div class="form-group">
						<label for="tempattinggal" class="col-sm-3 control-label">Bertempat Tinggal</label>
						<div class="col-sm-9">
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<a href="#tab_3" data-toggle="tab" class="btn btn-primary">SELANJUTNYA</a> <br /><small><i>*Pastikan data diisi semua</i></small>
						</div>
					</div> <!-- /.form-group -->
				</div><!-- /.tab-pane -->
				...
				<div class="tab-pane" id="tab_3">
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							...
							<a href="#tab_4" data-toggle="tab" class="btn btn-primary">SELANJUTNYA</a> <br /><small><i>*Pastikan data diisi semua</i></small>
						</div>
					</div> <!-- /.form-group -->
				</div><!-- /.tab-pane -->
				...
				<div class="tab-pane" id="tab_4">
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							...
							<a href="#tab_5" data-toggle="tab" class="btn btn-primary">SELANJUTNYA</a> <br /><small><i>*Pastikan data diisi semua</i></small>
						</div>
					</div> <!-- /.form-group -->
				</div><!-- /.tab-pane -->
				...
				<div class="tab-pane" id="tab_5">
					<h3 class="page-header">B. Data Pribadi Orang Tua ( WALI | Jika Siswa Tinggal dengan Wali)</h3>
					<div class="form-group">
						<label for="namawali" class="col-sm-3 control-label">Nama Wali</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" id="namawali" name="namawali" placeholder="Nama Wali" />
						</div>
					</div> <!-- /.form-group -->
					<div class="form-group">
						<label for="ttlwali" class="col-sm-3 control-label">Tempat, Tanggal Lahir</label>
						<div class="col-sm-5">
							<input type="text" class="form-control" id="tempatlahirwali" name="tempatlahirwali" placeholder="Tempat Lahir Wali ..." />
						</div>
						<div class="col-sm-4">
							<input type="text" class="form-control" id="tgllahirwali" name="tgllahirwali" placeholder="Tanggal Lahir" /> Ex: 20-08-2001
						</div>
					</div> <!-- /.form-group -->
					<div class="form-group">
						<label for="alamatwali" class="col-sm-3 control-label">ALamat Lengkap</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" id="alamatwali" name="alamatwali" placeholder="ALamat Lengkap.." />
						</div>
					</div> <!-- /.form-group -->
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" id="instansiwali" name="instansiwali" placeholder="Instansi Tempat Bekerja.." />
						</div>
					</div> <!-- /.form-group -->
					<div class="form-group">
						<label for="penghasilanwali" class="col-sm-3 control-label">Penghasilan / Bulan</label>
						<div class="col-sm-9">
							<input type="number" class="form-control" id="penghasilanwali" name="penghasilanwali" />
						</div>
					</div> <!-- /.form-group -->
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control" id="organisasiwali" name="organisasiwali" placeholder="Nama Organisasi.." />
						</div>
					</div> <!-- /.form-group -->
					<div class="form-group">
						<label for="jabatanwali" class="col-sm-3 control-label">Jabatan</label>
						<div class="col-sm-9">
							<input type="text" class="form-control" id="jabatanwali" name="jabatanwali" placeholder="Jabatan dalam Organisasi.." />
						</div>
					</div> <!-- /.form-group -->
					<div class="form-group">
					...
					<div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							...
							<input type="submit" class="btn btn-warning" id="daftar" name="daftar" value="DAFTAR SEKARANG" /> <br /><small><i>*Pastikan data diisi semua</i></small>
						</div>
					</div> <!-- /.form-group -->
				</div><!-- /.tab-pane -->
			</div><!-- /.tab-content -->
